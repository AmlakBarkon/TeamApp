...
teams = Team.create([{team_name: "Chelsea", coach: "Antonio Conte"},
  ...
  players = Player.create([{name: "Eduardo",nationality:"Portugal",age:34,img_url:"http://s.weltsport.net/bilder/spieler/gross/26152.jpg",team_id:1},
    ...
    {name:"Nathaniel Chalobah",nationality:"England",age:23,img_url:"http://s.weltsport.net/bilder/spieler/gross/174148.jpg",team_name:1},
    ...
    {name:"Alberto Moreno", nationality:"Spain",age:25,img_url:"http://s.weltsport.net/bilder/spieler/gross/209880.jpg",tema_id:3}
    {name:"Trent Alexander-Arnold", nationality:"England",age:"19",img_url:"http://s.weltsport.net/bilder/spieler/gross/288031.jpg",team_iid:3}
    ])
